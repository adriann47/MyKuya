...
class ShoppingPreview extends StatefulWidget {
  const ShoppingPreview({super.key});

  @override
  State<ShoppingPreview> createState() => _ShoppingPreviewState();
}

class _ShoppingPreviewState extends State<ShoppingPreview> {
    ...
    return Scaffold(
      ...
      Column(
        ...
        children: [
          ...
          Image.asset('assets/icons/grusire.png'),
          Padding(
